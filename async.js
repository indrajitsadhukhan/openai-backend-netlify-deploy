...
var url = "https://www.pwc.in/research-and-insights-hub/immersive-outlook/immersive-outlook-with-tata-steel.html";
var question = "What initiatives Tata steel has taken to manage carbon footprint ?"
...
async function askQuestion(plainText,question)
{
  ...
  var responseAns="";
  await axios.post(API_URL+'/completion',{
